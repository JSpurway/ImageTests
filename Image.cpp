...
{
// calculate index into array for red ( then +1 green +2 blue)
auto index=0;
m_pixels[index]=_r;
m_pixels[index+1]=_g;
m_pixels[index+2]=_b;
...
void void Image::getPixel(unsigned int _x, unsigned int _y, unsigned char &o_r, unsigned char &o_g, unsigned char &o_b)
{
    size_t index=0;
    o_r=m_pixels[index];
